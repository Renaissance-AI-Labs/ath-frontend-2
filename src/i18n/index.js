...
const languagePacks = {
  'zh-cn': {
    ...
    'crash.resultWon': '赢了',
    'crash.resultLost': '爆了',
    'crash.insufficientBalance': 'ATHP余额不足',
    ...
    'banker.amountLabel': '金额 (ATHP)',
    'banker.balanceLabel': '余额: {amount} ATHP',
    'banker.approving': '授权中...',
    'banker.approve': '授权 ATHP',
  ...
  'zh-tw': {
    ...
    'crash.resultWon': '赢了',
    'crash.resultLost': '爆了',
    'crash.insufficientBalance': 'ATHP餘額不足',
    ...
    'banker.amountLabel': '金額 (ATHP)',
    'banker.balanceLabel': '餘額: {amount} ATHP',
    'banker.approving': '授權中...',
    'banker.approve': '授權 ATHP',
    'banker.depositing': '存入中...',
    'banker.deposit': '存入',
  ...
  'en': {
    ...
    'crash.youWon': 'You Won {amount} ATHP!',
    ...
    'crash.insufficientBalance': 'Insufficient ATHP balance',
    ...
    'sidebar.collectPoints': 'Collect Points',
    ...
    'welfare.batchClaimAll': 'Claim All',
    ...
    'welfare.noRecords': 'No claimable points',
    ...
    'banker.amountLabel': 'Amount (ATHP)',
    'banker.balanceLabel': 'Balance: {amount} ATHP',
    'banker.approving': 'Approving...',
    'banker.approve': 'Approve ATHP',
  ...
  'ja': {
    ...
    // Crash Game
    'crash.betAmount': 'ベット額 (ATHP)',
    'crash.amountPlaceholder': '金額',
    'crash.balance': '残高: {amount} ATHP',
    'crash.prediction': '予想倍率',
    'crash.winChance': '勝率: {chance}%',
    'crash.connectWallet': 'ウォレット接続',
    'crash.approve': 'ATHPを承認',
    'crash.approving': '承認中...',
    'crash.bet': 'ベット',
    'crash.betting': 'ベット中...',
    ...
    'crash.settling': '決済中...',
    'crash.launching': '発射中...',
    'crash.youWon': '{amount} ATHP 獲得しました!',
    'crash.crashed': 'クラッシュ!',
    'crash.myBets': '自分のベット',
    'crash.allBets': '全ベット',
    'crash.time': '時間',
    ...
    'crash.resultWon': 'WIN',
    'crash.resultLost': 'CRASHED',
    'crash.insufficientBalance': 'ATHP残高不足',
    'crash.rules': 'ゲームルール',
    ...
    'sidebar.collectPoints': 'ポイントを受け取る',
    ...
    'welfare.noRecords': '請求可能なポイントはありません',
    ...
    'banker.amountLabel': '金額 (ATHP)',
    'banker.balanceLabel': '残高: {amount} ATHP',
    'banker.approving': '承認中...',
    'banker.approve': 'ATHPを承認',
  ...
  'ko': {
    ...
    'crash.resultWon': 'WIN',
    'crash.resultLost': 'CRASHED',
    'crash.insufficientBalance': 'ATHP 잔액 부족',
    'crash.rules': '게임 규칙',
    ...
    'welfare.noRecords': '청구 가능한 포인트 없음',
    ...
    'banker.amountLabel': '금액 (ATHP)',
    'banker.balanceLabel': '잔액: {amount} ATHP',
    'banker.approving': '승인 중...',
    'banker.approve': 'ATHP 승인',
